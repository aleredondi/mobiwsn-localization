...
public class ShimmerInternalMote extends GenericInternalMote
{

	public ShimmerInternalMote(String moteId, InternalNetworkAddressImpl newtorkAddress,
		...
		//System.out.println("Creo un generic con shimmer");
	}
	...
	{
		if (o instanceof ShimmerInternalMote)
		{
			ShimmerInternalMote mote = (ShimmerInternalMote) o;
	...
	protected Mote createRemote() {
		try {
			return new ShimmerRemoteMote(this);
