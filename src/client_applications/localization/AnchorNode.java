...
public class AnchorNode extends LauraNode{
	...
	public AnchorNode(String id, double x, double y, boolean reachable, Mote mote_ref){
		this.id = id;
		this.x = x;
		this.y = y;
	...
	public AnchorNode(String id, double x, double y, boolean reachable) {
		this.id = id;
		this.x = x;
		this.y = y;
		setIs_reachable(reachable);
