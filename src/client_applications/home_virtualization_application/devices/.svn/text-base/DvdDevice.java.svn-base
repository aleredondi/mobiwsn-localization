...
public class DvdDevice extends DeviceImpl{
	
	
	static DeviceStatus previousStatus;
	...
	public DvdDevice(DeviceType t, String path,HomeVirtualizationApplicationImpl h) throws RemoteException{
		super(t,path,h);
		imgPath=imgPath+"/devices/dvd.png";
		status=DeviceStatus.OFF;
		previousStatus=DeviceStatus.OFF;
		consume=new Hashtable<DeviceStatus,Double>();
		consume.put(DeviceStatus.OFF, (double) 0);
		consume.put(DeviceStatus.STANDBY,(double) 1);
