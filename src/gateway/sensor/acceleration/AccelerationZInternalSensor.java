...
public class AccelerationZInternalSensor extends GenericInternalSensor<ValueResult,Double, Dimensionless> {
private ValueResult value; //Object container of the value
	 ...
	 */
	public AccelerationZInternalSensor(byte sensorId,InternalMote owner) throws RemoteException
	{
...
//		this.value=new ValueResultImpl(2, "Decibel", measure, rangeTop, rangeDown, this.remoteSensor);
		this.sensorType = SensorType.ACCELEROMETERZ;
		System.out.println("Son un accelz sensor");
}
