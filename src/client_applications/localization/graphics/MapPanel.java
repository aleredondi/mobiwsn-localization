...
class MapPanel extends JComponent implements MouseListener, MouseMotionListener, MouseWheelListener {
	...
	private boolean drawingRule, drawingAnchors, positioningAnchors;
 ...
 public MapPanel(ArrayList<AnchorNode> anchor_list, ArrayList<MobileNode> mobile_list, LauraMainWindow lmw) {
