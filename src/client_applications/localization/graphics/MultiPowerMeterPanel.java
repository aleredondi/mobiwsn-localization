...
public class MultiPowerMeterPanel extends JFrame implements ActionListener,
		ChangeListener, ComponentListener {

	private static final long serialVersionUID = 1L;
	private ArrayList<DefaultValueDataset> powerConsumtionDatasetPerAp;
	...
	public MultiPowerMeterPanel(ArrayList<AccessPoint> access_points_list,
			LauraMainWindow lmw) {
	...
	private void createLayout() {
		...
		this.powerConsumtionDatasetPerAp = new ArrayList<DefaultValueDataset>();
		...
		this.setTitle("Small Cell Power Consuption");
